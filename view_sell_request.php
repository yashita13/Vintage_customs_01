...
echo "<H4>Welcome<BR>Administrator</H4>";
echo "<center><H1><U>Sell Requests From Customers</U></H1></center>";
    ...
    <section>
        ...
        <table>
            ...
            <?php 
                ...
                {
					$Image1 = "http://localhost/vintagecustoms/uploadedimages/".$rows['Image1'];
					$Image2 = "http://localhost/vintagecustoms/uploadedimages/".$rows['Image2'];
					//echo $Image1; echo "<BR>";
					//echo $Image2;echo "<BR>";
            ?>
            <tr>
